...
public class DataInitializer {
        ...
        List<Movie> moviesToSave = sampleMovies.stream()
                .map(sampleMovie -> {
                    ...
                    if (existingMovie != null) {
                        ...
                        // Maintain existing streaming progress if any (handled by other services)
                    }
                    return sampleMovie;
                })
                .toList();
    ...
    private boolean matchesSeed(Movie existingMovie, Movie sampleMovie) {
        ...
        return sampleMovie.getGenre().equals(existingMovie.getGenre())
                ...
                && sampleMovie.isHasFullMovie() == existingMovie.isHasFullMovie()
                && Objects.equals(sampleMovie.getDurationMinutes(), existingMovie.getDurationMinutes());
    }

    private List<Movie> buildSampleMovies() {
        final String sintelUrl = "https://download.blender.org/durian/trailer/sintel_trailer-1080p.mp4";
        final String bunnyUrl = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4";
        final String steelUrl = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4";
        final String dreamUrl = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4";

        Movie laLaLand = new Movie(null, "La La Land", "Romance", 2016,
        ...
        laLaLand.setStreamType("MP4");
        laLaLand.setHasFullMovie(true);
        laLaLand.setDurationMinutes(52);
        laLaLand.setIntroStart(0);
        laLaLand.setIntroEnd(12);
        laLaLand.setAvailableQualities(List.of("720p", "1080p"));
        laLaLand.setSubtitles(List.of("EN", "VI"));
        laLaLand.setSubtitleUrls(List.of("https://moviex.demo/subtitles/sintel_en.vtt"));

        Movie johnWick = new Movie(null, "John Wick: Chapter 4", "Action", 2023,
        ...
        johnWick.setStreamType("MP4");
        johnWick.setHasFullMovie(true);
        johnWick.setDurationMinutes(10);
        johnWick.setIntroStart(5);
        johnWick.setIntroEnd(18);
        johnWick.setAvailableQualities(List.of("480p", "720p", "1080p"));
        johnWick.setSubtitles(List.of("EN"));
        johnWick.setSubtitleUrls(List.of("https://moviex.demo/subtitles/bunny_en.vtt"));

        Movie dune = new Movie(null, "Dune", "Sci-Fi", 2021,
                ...
                SubscriptionPlan.PREMIUM);
        dune.setStreamType("MP4");
        dune.setHasFullMovie(true);
        dune.setDurationMinutes(12);
        dune.setIntroStart(2);
        dune.setIntroEnd(14);
        dune.setAvailableQualities(List.of("1080p"));
        dune.setSubtitleUrls(List.of("https://moviex.demo/subtitles/steel_en.vtt"));

        Movie oppenheimer = new Movie(null, "Oppenheimer", "Drama", 2023,
                ...
                SubscriptionPlan.PREMIUM);
        oppenheimer.setStreamType("MP4");
        oppenheimer.setHasFullMovie(true);
        oppenheimer.setDurationMinutes(11);
        oppenheimer.setIntroStart(0);
        oppenheimer.setIntroEnd(8);
        oppenheimer.setAvailableQualities(List.of("720p", "1080p"));
        oppenheimer.setSubtitleUrls(List.of("https://moviex.demo/subtitles/dream_en.vtt"));
